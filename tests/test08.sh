...
./pigs-show a:3
# it is a wrong input so it should show an error:
# pigs-show: error: invalid argument

./pigs-show 1:e
# there is no e file so it should show an error:
#  pigs-show: error: 'e' not found in commit 1
